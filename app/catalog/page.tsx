...
export default function Catalog() {
	return (
		<section>
			<div className='px-4 py-8 mx-auto max-w-screen-3xl sm:py-12 sm:px-6 lg:px-8'>
				<header>
				...
				<div className='mt-4 lg:mt-8 lg:grid lg:grid-cols-4 lg:items-start lg:gap-8'>
					<div className='hidden space-y-4 lg:block'>
						<div>
							...
							<select id='SortBy' className='p-2 mt-1 text-sm border-gray-300 rounded'>
										...
										<ul className='p-4 space-y-1 border-t border-gray-200'>
											<li>
												<label htmlFor='FilterInStock' className='inline-flex items-center gap-2'>
													<input type='checkbox' id='FilterInStock' className='border-gray-300 rounded size-5' />
											...
											<li>
												<label htmlFor='FilterPreOrder' className='inline-flex items-center gap-2'>
													<input type='checkbox' id='FilterPreOrder' className='border-gray-300 rounded size-5' />
											...
											<li>
												<label htmlFor='FilterOutOfStock' className='inline-flex items-center gap-2'>
													<input type='checkbox' id='FilterOutOfStock' className='border-gray-300 rounded size-5' />
										...
										<ul className='p-4 space-y-1 border-t border-gray-200'>
											<li>
												<label htmlFor='FilterRed' className='inline-flex items-center gap-2'>
													<input type='checkbox' id='FilterRed' className='border-gray-300 rounded size-5' />
											...
											<li>
												<label htmlFor='FilterBlue' className='inline-flex items-center gap-2'>
													<input type='checkbox' id='FilterBlue' className='border-gray-300 rounded size-5' />
											...
											<li>
												<label htmlFor='FilterGreen' className='inline-flex items-center gap-2'>
													<input type='checkbox' id='FilterGreen' className='border-gray-300 rounded size-5' />
											...
											<li>
												<label htmlFor='FilterOrange' className='inline-flex items-center gap-2'>
													<input type='checkbox' id='FilterOrange' className='border-gray-300 rounded size-5' />
											...
											<li>
												<label htmlFor='FilterPurple' className='inline-flex items-center gap-2'>
													<input type='checkbox' id='FilterPurple' className='border-gray-300 rounded size-5' />
											...
											<li>
												<label htmlFor='FilterTeal' className='inline-flex items-center gap-2'>
													<input type='checkbox' id='FilterTeal' className='border-gray-300 rounded size-5' />
