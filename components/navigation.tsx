...
import { H2, H3, P1 } from '@/components/ui/typography';
	...
	return (
		<motion.div
			...
			<nav className='grid h-full w-full grid-cols-1 place-content-end gap-4 px-4 pb-8 pt-32 md:grid-cols-[1fr_1fr_1fr] md:gap-8 md:px-8'>
				...
				<div className='w-full space-y-2'>
					<Link href='/' onClick={closeMenu} className='group flex items-center justify-start px-4 py-4 transition duration-150 hover:bg-foreground hover:text-background'>
						<H3>Cart</H3>
