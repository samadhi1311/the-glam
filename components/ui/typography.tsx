...
function H1({ className, children }: { className?: string; children?: React.ReactNode }) {
	return <h1 className={cn('playfair text-4xl xs:text-6xl sm:text-7xl md:text-8xl lg:text-9xl uppercase', className)}>{children}</h1>;
}

function H2({ className, children }: { className?: string; children?: React.ReactNode }) {
	return <h1 className={cn('playfair text-4xl md:text-5xl tracking-wide', className)}>{children}</h1>;
}

function H3({ className, children }: { className?: string; children?: React.ReactNode }) {
	return <h2 className={cn('text-2xl md:text-3xl tracking-wide font-light', className)}>{children}</h2>;
}
